    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="form-group">
          <?php echo $this->Form->input('CaseRecordFile.name', array('label' => 'Dosya adı: ', 'class' => 'form-control', 'autofocus' => 'autofocus')); ?>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          <?php echo $this->Form->input('CaseRecordFile.file_name', array('label' => 'Dosya (Max.' . ini_get("upload_max_filesize") . '): ', 'class' => null, 'type' => 'file')); ?>
        </div>
      </div>
    </div>
    <div class="row">
...
<div class="well">
  <div class="page-header" style="margin-top:0px;">
    <h4>Yeni dava olayı ekle</h4>
  </div>
  <?php echo $this->Form->create("CaseRecordFile", array('enctype' => 'multipart/form-data', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'help-block'))))); ?>
    <?php echo $this->Form->input('CaseRecordFile.case_record_id', array('type' => 'hidden', 'value' => $this->request->data['CaseRecord']['id'])); ?>
    <?php echo $this->Form->input('CaseRecordFile.name', array('type' => 'hidden', 'value' => 'Olay')); ?>
    <?php echo $this->Form->input('CaseRecordFile.date', array('type' => 'hidden', 'value' => $this->time->format(new DateTime(), "%Y-%m-%d %H:%M:%S", null, "Europe/Istanbul"))); ?>
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          <?php echo $this->Form->input('CaseRecordFile.description', array('label' => 'Olay açıklaması: ', 'class' => 'form-control')); ?>
        </div>
      </div>
    </div>
    <div class="row">
