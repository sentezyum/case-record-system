...
<?php $this->Html->script('directive/bt_customer_select/BtCustomerSelect.js?v1.2', array('inline' => false)); ?>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            <?php echo $this->Form->input('CaseRecord.no', array('label' => 'Büro kart no: ', 'class' => 'form-control')); ?>
          </div>
        </div>
      </div>
      <div class="row">
